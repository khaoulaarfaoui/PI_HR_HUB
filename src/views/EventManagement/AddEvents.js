...
import { CreateEvents,UpdateEvents } from "../../Redux/actions/event/EventAction";
...
const AddEvent = ({...props }) => {
  ...
  const handleSubmit = e => {
        ...
        const onSuccess = () => {
          ButterToast.raise({
              content: <Cinnamon.Crisp title="Event Notification"
    ...
    if (validate()) {
        ...
        if (props.currentId == 0)
            ...
            props.updateEvents(props.currentId, values, onSuccess)
    }
  }
    ...
    <>
        ...
        <div className="rounded-t bg-white mb-0 px-6 py-6">
          <div className="text-center flex justify-between">
            <h6 className="text-gray-800 text-xl font-bold">Add & Edit Events</h6>
          </div>
        </div>
