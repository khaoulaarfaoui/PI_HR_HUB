...
import { findallHrTestQuestion } from "../../Redux/actions/hrtest/hrtest";
...
const Question = (props) => {
  ...
  useEffect(() => {
    ...
    console.log("idTest",localStorage.getItem("idTest"))
      ...
      >
        ...
        <div className="block w-full overflow-x-auto">
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
             {
                console.log("propssss TestQuestionList ",props.TestQuestionList)
             }
