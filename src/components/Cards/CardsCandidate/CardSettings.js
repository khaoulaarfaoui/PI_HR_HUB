...
import { filePDF } from "../../../assets/KhaoulaArfaouiResume English.pdf";
// components
      ...
      <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-200 border-0">
        ...
        {/* <div>
          <Document
            file={{
              url:
                "http://www.http://pageperso.lif.univ-mrs.fr/~frederic.olive/Materiel/langagesL2/cours.pdf.com/sample.pdf",
            }}
              ...
              <div className="w-full lg:w-12/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    type="text"
                    className="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full ease-linear transition-all duration-150"
                    value={(candidate.data.region, candidate.data.location)}
                  />
                </div>
              </div>
            </div>
