...
import teststyles from "../assets/styles/componentsStyles/Testelement.module.css";
import axios from "axios";
import Resultelement from "./ResultElement.component";
import styles from "../assets/styles/componentsStyles/Dashboard.module.css";
import resultstyles from "../assets/styles/componentsStyles/TestResult.module.css";
...
function Testresult(props) {
  ...
  useEffect(() => {
    ...
    axios
      .post("http://localhost:8082/api/test/getresults", { pin: props.location.state.pin }, options)
